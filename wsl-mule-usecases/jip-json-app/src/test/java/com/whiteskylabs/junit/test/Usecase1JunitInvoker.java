...
public class Usecase1JunitInvoker  extends FunctionalTestCase {
	 ...
	 */
	@Test
	public void invokeJUsecase1() throws Exception {
		
		Flow flow = (Flow) getFlowConstruct("jip-usecase1");
		...
		System.out.println("Payload: "+result.getMessage().getPayloadAsString());
