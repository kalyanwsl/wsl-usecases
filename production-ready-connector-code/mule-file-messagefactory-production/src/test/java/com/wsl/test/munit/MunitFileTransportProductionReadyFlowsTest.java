...
public class MunitFileTransportProductionReadyFlowsTest extends FunctionalMunitSuite {
	...
	private static Logger log = Logger
			   .getLogger(MunitFileTransportProductionReadyFlowsTest.class.getName());
	@Test
